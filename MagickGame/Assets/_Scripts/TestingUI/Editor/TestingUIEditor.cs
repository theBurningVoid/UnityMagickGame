...
public class TestingUIEditor : Editor {
	...
	public void OnSceneGUI()
	{
		...
		case EventType.MouseDown: 
			...
			case 0:
				Debug.Log ("Left mouse button down at " + current.mousePosition.ToString ());
				break;
			case 1://yeah I know 1 should be middle click and 2 right click but unity/maybe c# as i forget which
				Debug.Log ("Right mouse button down at " + current.mousePosition.ToString ());
				break;
			case 2:
				Debug.Log ("Middle mouse button down at " + current.mousePosition.ToString ());
				break;
			}
			current.Use ();
			break;
		case EventType.MouseUp:
			switch (current.button) {
			case 0:
				Debug.Log ("Left mouse button up at " + current.mousePosition.ToString ());
				break;
			case 1:
				Debug.Log ("Right mouse button up at " + current.mousePosition.ToString ());
				break;
			case 2:
				Debug.Log ("Middle mouse button up at " + current.mousePosition.ToString ());
				break;
			}
			current.Use ();
			break;
